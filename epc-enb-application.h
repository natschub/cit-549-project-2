...
public:
  ...
  EpcEnbApplication (Ptr<Socket> lteSocket, Ptr<Socket> s1uSocket, Ptr<Socket> xwSocket, Ipv4Address enbS1uAddress, Ipv4Address sgwS1uAddress, Ipv4Address xwAddress, uint16_t cellId);
  /**
   * Destructor
   * 
   */
